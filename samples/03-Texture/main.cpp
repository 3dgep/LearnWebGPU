...
void inspectAdapter( WGPUAdapter adapter )
{
    ...
    if ( wgpuAdapterGetLimits( adapter, &supportedLimits ) == WGPUStatus_Success )
    {
        ...
        std::cout << "  maxBindGroupsPlusVertexBuffers:            " << deviceLimits.maxBindGroupsPlusVertexBuffers
                  << std::endl;
        std::cout << "  maxBindingsPerBindGroup:                   " << deviceLimits.maxBindingsPerBindGroup
                  << std::endl;
        ...
        std::cout << "  maxSampledTexturesPerShaderStage:          " << deviceLimits.maxSampledTexturesPerShaderStage
                  << std::endl;
        std::cout << "  maxSamplersPerShaderStage:                 " << deviceLimits.maxSamplersPerShaderStage
                  << std::endl;
        std::cout << "  maxStorageBuffersPerShaderStage:           " << deviceLimits.maxStorageBuffersPerShaderStage
                  << std::endl;
        std::cout << "  maxStorageTexturesPerShaderStage:          " << deviceLimits.maxStorageTexturesPerShaderStage
                  << std::endl;
        std::cout << "  maxUniformBuffersPerShaderStage:           " << deviceLimits.maxUniformBuffersPerShaderStage
                  << std::endl;
        std::cout << "  maxUniformBufferBindingSize:               " << deviceLimits.maxUniformBufferBindingSize
                  << std::endl;
        std::cout << "  maxStorageBufferBindingSize:               " << deviceLimits.maxStorageBufferBindingSize
                  << std::endl;
        std::cout << "  minUniformBufferOffsetAlignment:           " << deviceLimits.minUniformBufferOffsetAlignment
                  << std::endl;
        std::cout << "  minStorageBufferOffsetAlignment:           " << deviceLimits.minStorageBufferOffsetAlignment
                  << std::endl;
        ...
        std::cout << "  maxVertexBufferArrayStride:                " << deviceLimits.maxVertexBufferArrayStride
                  << std::endl;
        std::cout << "  maxInterStageShaderComponents:             " << deviceLimits.maxInterStageShaderComponents
                  << std::endl;
        std::cout << "  maxInterStageShaderVariables:              " << deviceLimits.maxInterStageShaderVariables
                  << std::endl;
        std::cout << "  maxColorAttachments:                       " << deviceLimits.maxColorAttachments << std::endl;
        std::cout << "  maxComputeWorkgroupStorageSize:            " << deviceLimits.maxComputeWorkgroupStorageSize
                  << std::endl;
        std::cout << "  maxComputeInvocationsPerWorkgroup:         " << deviceLimits.maxComputeInvocationsPerWorkgroup
                  << std::endl;
        std::cout << "  maxComputeWorkgroupSizeX:                  " << deviceLimits.maxComputeWorkgroupSizeX
                  << std::endl;
        std::cout << "  maxComputeWorkgroupSizeY:                  " << deviceLimits.maxComputeWorkgroupSizeY
                  << std::endl;
        std::cout << "  maxComputeWorkgroupSizeZ:                  " << deviceLimits.maxComputeWorkgroupSizeZ
                  << std::endl;
