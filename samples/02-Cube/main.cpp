...
void init()
{
    ...
    // Describe a uniform buffer to store the MVP matrix.
    ...
    bindGroupLayoutDesc.label      = "Binding Group";
...
WGPUTextureView getNextSurfaceTextureView( WGPUSurface s )
{
    ...
    // Note: this causes issues with wgpu-native.
    // TODO: Fix this for wgpu-native.
    wgpuTextureRelease( surfaceTexture.texture );
